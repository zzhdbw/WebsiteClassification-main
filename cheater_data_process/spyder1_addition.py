...
def read(url):
    ...
    response = requests.get(url, headers=headers, timeout=(5, 5)) # 发送HTTP请求
...
def frocess_test(start, end):
    with open("data/processed/addition.csv", "r", encoding="utf8") as f,\
            open("data/processed/addition_spyder_{}.csv".format(end), "w", encoding="utf8") as w:
